...
| `verify-rag-pipeline` | RAG 파이프라인 검증 | `backend/**/answer/**/*.java`, `backend/**/analysis/*.java`, `backend/**/search/*.java`, `backend/**/vector/*.java`, `backend/**/document/DocumentDownloadController.java`, `backend/**/prompt/*.java`, `backend/**/resources/prompts/*.txt` |
